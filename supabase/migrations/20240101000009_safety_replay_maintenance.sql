...
-- Prototype Evaluation Scenario Dataset for Academic Evaluation
...
-- Seed Prototype Evaluation Scenarios for Replay Mode (Synthetic Calibration Data)
INSERT INTO public.disaster_events (
    ...
    'EVENT_001',
    'Prototype Scenario 01: Severe Monsoon Inflow Simulation',
    'Synthetic scenario evaluating rapid watershed inflow exceeding 85% reservoir threshold. Automated 50% controlled emergency release (90°) and simulated civilian advisory SMS.',
    '2026-05-18',
    92.4,
    148.5,
    50,
    1240,
    '[
      {"time": "08:00", "water_level": 58.0, "rainfall": 12.0, "gate": 0, "status": "NORMAL", "action": "Routine Baseline Monitoring"},
      {"time": "09:00", "water_level": 72.5, "rainfall": 38.0, "gate": 0, "status": "PRE_WARNING", "action": "Gate 0% Closed (Water Conservation), Early warning SMS"},
      {"time": "10:00", "water_level": 81.0, "rainfall": 45.0, "gate": 20, "status": "CONTROLLED_RELEASE", "action": "Gate opened 20% (36° Buffer Release), Downstream advisory"},
      {"time": "11:00", "water_level": 92.4, "rainfall": 53.5, "gate": 50, "status": "DANGER", "action": "Gate 50% Controlled Emergency Release (90°), SMS Alert Broadcast"}
    ]'::jsonb
), (
    'EVENT_002',
    'Prototype Scenario 02: Upstream Catchment Surge Simulation',
    'Synthetic trans-basin surge simulation without local rainfall. Hybrid AI lookahead flags inflow anomaly 45 minutes ahead.',
    '2026-08-10',
    86.2,
    5.0,
    50,
    ...
    '[
      ...
      {"time": "16:00", "water_level": 86.2, "rainfall": 3.0, "gate": 50, "status": "DANGER", "action": "Gate Actuation 50% (90° Emergency Spillway)"}
    ]'::jsonb
...
('ESP32_PUTTALAM_01', 'MG996R Spillway Servo Actuator', '2026-08-10', '2026-11-10', 'Eng. Adrian Dias', 'CALIBRATED', 'Metal gears lubricated, prototype 0–90° operational torque calibrated at 11 kg-cm'),
