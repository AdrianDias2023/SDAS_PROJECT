  ...
  return (
    ...
    >
      <Tab.Screen
        ...
        options={{ tabBarIcon: ({ focused }) => <TabIcon emoji="🏠" focused={focused} />, tabBarLabel: t('tabHome') || 'Home' }}
      />
      <Tab.Screen
        name="Alerts"
        component={AlertsScreen}
        options={{ tabBarIcon: ({ focused }) => <TabIcon emoji="🔔" focused={focused} />, tabBarLabel: t('tabAlerts') || 'Alerts' }}
      />
      <Tab.Screen
        name="Community"
      ...
      <Tab.Screen
        ...
        options={{ tabBarIcon: ({ focused }) => <TabIcon emoji="🛡️" focused={focused} />, tabBarLabel: t('safetyGuidelines') || 'Safety' }}
      />
      <Tab.Screen
        name="More"
        component={AboutScreen}
        options={{ tabBarIcon: ({ focused }) => <TabIcon emoji="⚙️" focused={focused} />, tabBarLabel: t('tabAbout') || 'More' }}
      />
    </Tab.Navigator>
  );
}
